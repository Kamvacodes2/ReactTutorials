...
export default function Deal() {
    ...
    return (
        <main>
            ...
            <div className='fixed top-[13%] right-[3%] z-10 bg-white cursor-pointer border-2 border-gray-400 rounded-full w-12 h-12
            ...
            <div className='m4 max-w-3xl lg:mx-auto p-4 rounded-lg border-3 shadow-lg bg-white lg:space-x-5'>
                <div className=' w-full'>
                    ...
                    <div className='flex justify-start items-center space-x-4 w-[75%]'>
                        ...
                        <div>
                            <p className='bg-green-800 w-full max-w-[200px] rounded-md p-1 text-white text-center font-semibold
                        shadow-md'>{deal.type === "manual" ? "Manual" : "Automatic"}</p>
                        </div>
                    </div>
                ...
                {deal.userRef !== auth.currentUser?.uid && !contactOwner &&  (
                    <div className='mt-6'>
                        <button onClick={() =>setContactOwner(true)} className='px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded 
                                shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg  text-center transition duration-150 
                                ease-in-out '>Contact Owner</button>
                    </div>
                )}
                {contactOwner && (
